...
function renderBrowserPlaybook(): string {
  return [
    ...
    '2. Use browser_navigate or browser_tabs to进入目标页，再调用 browser_snapshot 获取结构化页面状态。',
    '3. 之后只用 browser_click / browser_type / browser_select_option / browser_press_key / browser_wait_for 做小步操作。',
